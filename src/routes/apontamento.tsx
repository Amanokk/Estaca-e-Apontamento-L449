...
import { getCrewLabel, getDeviceId, loadLast, saveLast, setCrewLabel, useGps } from "@/lib/field-geo";
    ...
    <AppShell>
      <header className="px-4 pb-3 pt-[max(16px,env(safe-area-inset-top))]">
        ...
        <div className="mt-3 flex gap-2">
          <Link to="/cadastros" className="text-xs font-medium text-accent">
            Cadastros
          </Link>
          <span className="text-muted">·</span>
          <Link to="/relatorio" className="text-xs font-medium text-accent">
            Relatório
          </Link>
          <span className="text-muted">·</span>
          <Link to="/mapa" className="text-xs font-medium text-accent">
            Equipe no mapa
          </Link>
        </div>

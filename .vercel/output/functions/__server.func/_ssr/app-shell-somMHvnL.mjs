...
import { D as ClipboardList, g as MapPinned, j as CalendarDays, p as Plus, x as Images } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app-shell-somMHvnL.js
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: NAV.map((item) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: item.to,
						className: cn("flex min-h-12 flex-col items-center justify-center gap-0.5 rounded-md text-[11px] font-medium transition-colors duration-150", active ? "text-accent" : "text-muted"),

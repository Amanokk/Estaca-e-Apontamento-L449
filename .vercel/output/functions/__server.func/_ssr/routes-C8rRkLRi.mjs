		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-4 font-display text-2xl font-semibold tracking-tight text-fg",
					children: "Estaca GPS"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "text-xs uppercase tracking-widest text-muted",
					children: "L449 · São Joaquim"
				})
			]
		})
	});
...
async function openWideCamera() {
	...
	const tryGet = (video) => navigator.mediaDevices.getUserMedia({
		audio: false,
		video
	});
	try {
		...
		try {
			return {
				stream: await tryGet({ facingMode: { ideal: "environment" } }),
				mock: false
			};
		} catch {
			return {
...
function CameraCapture({ stamp, onClose }) {
	...
	const capture = (0, import_react.useCallback)(async () => {
		...
		const rawUrl = addExif(canvas.toDataURL("image/jpeg", .95), {
			lat: stamp.lat,
			lng: stamp.lng,
			estaca: stamp.estaca,
			street: stamp.street,
		...
		const stampedUrl = addExif(canvas.toDataURL("image/jpeg", .95), {
			lat: stamp.lat,
			lng: stamp.lng,
			estaca: stamp.estaca,
			street: stamp.street,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			flash && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 bg-fg/80" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "flex items-center justify-between rounded-lg bg-subtle px-3 py-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Mostrar mini mapa Google" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									type: "checkbox",
			...
			toast && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-x-8 bottom-28 rounded-full bg-accent px-4 py-2 text-center text-sm font-semibold text-accent-fg",
				children: toast
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var MAX_ACCURACY_FIRST = 180;
var MAX_ACCURACY_KEEP = 90;
var MAX_SPEED = 35;
function useGeolocation(enabled = true) {
	...
	(0, import_react.useEffect)(() => {
		...
		const apply = (pos) => {
			...
			if (prev) {
				...
				if (acc <= 12) {
					...
					const mix = acc < prev.acc ? Math.max(k, .55) : k;
					next = {
		...
		const onError = (err) => {
			setState((s) => ({
				...s,
				error: err.message || "Não foi possível obter o GPS."
			}));
		};
		const opts = {
...
function Index() {
	...
	(0, import_react.useEffect)(() => {
		...
		const t = setTimeout(() => setDemo(true), 8e3);
	...
	const apontarSearch = cameraMatch ? {
		estaca: String(cameraMatch.estaca),
		street: cameraMatch.street.name
	} : void 0;
	const streetShort = match?.street.name.replace(/^Rua /, "") ?? "";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative flex min-h-0 flex-1 flex-col bg-bg text-fg",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pointer-events-auto rounded-2xl border border-border bg-bg/88 p-3 shadow-card backdrop-blur-md",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between gap-2 text-xs font-medium uppercase tracking-widest text-muted",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "L449 · São Joaquim" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [
									...
									usingDemo ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "rounded-full bg-gps/15 px-2 py-0.5 text-gps",
										children: "Demo"
									}) : null,
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						match ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: streetShort
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "font-display text-3xl font-semibold leading-none tracking-tight",
									children: ["E-", match.estaca]
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "pb-0.5 text-right text-sm tabular-nums text-muted",
								children: [
									match.offset >= 0 ? "+" : "",
									match.offset.toFixed(1),
									" m",
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "block text-xs text-muted/70",
										children: [match.distance.toFixed(1), " m do eixo"]
									})
								]
							})]
						}) : geo.error && !usingDemo ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-muted",
									children: "Permita o acesso à localização."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setDemo(true),
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-muted",
									children: "Nenhuma rua a menos de 60 m."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => setDemo(true),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClipboardList, { className: "size-4" }), cameraMatch ? `Apontar E-${cameraMatch.estaca}` : "Apontar"]
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { className: "size-4" }), "Foto"]
							})]
						})
					]
				})

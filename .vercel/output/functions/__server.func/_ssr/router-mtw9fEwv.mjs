...
var FALLBACK_MESSAGE = "Algo deu errado. Recarregue a página e tente de novo.";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Não foi possível abrir esta tela"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-md text-sm break-words text-muted",
				children: isDb ? "O apontamento agora grava neste aparelho. Recarregue a página para continuar." : message
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
				href: "/",
				className: "mt-2 inline-flex min-h-11 items-center rounded-full bg-accent px-5 text-sm font-semibold text-accent-fg",
				children: "Voltar às estacas"
			})
		]
	});
}

...
import { a as PV_PREFIXES, i as NOTE_CHIPS, o as QUANTITY_LABEL, r as KIND_LABEL } from "./catalog-BdLsyFoE.mjs";
...
import { M as ArrowLeft, O as ChevronDown, b as LoaderCircle, k as Check } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { c as addActivity, r as Route$1 } from "./router-BRS6lCHF.mjs";
import { t as AppShell } from "./app-shell-somMHvnL.mjs";
import { C as useUpsertApontamento, S as useSnapshot, a as ScreenLoader, c as getDeviceId, d as loadLast, f as matchStreetByLabel, g as useCloseApontamento, i as Label, m as saveLast, o as Textarea, r as Input, t as Button, v as useGps, x as usePresencePing, y as useInvalidateSnapshot } from "./use-snapshot-DyKt-CW2.mjs";
import { i as usePlaceLabel, r as openForEquipment, t as GpsBanner } from "./crew-D6fgldI1.mjs";
import { n as ChoiceList, t as ChipRow } from "./choice-DtEvLaaF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/novo-Bny2HmNK.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cn("size-4 text-muted transition-transform duration-200 ease-out", open ? "rotate-180" : "rotate-0") })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function Novo() {
	const { edit, estaca: estacaFromMap, street: streetFromMap } = Route$1.useSearch();
	...
	(0, import_react.useEffect)(() => {
		...
		if (open) {
			...
			streetTouched.current = true;
			matchedStreet.current = true;
			const next = draftFromApontamento(open);
			if (estacaFromMap) next.estaca = String(estacaFromMap);
			if (streetFromMap && data?.streets) {
				const hit = data.streets.find((s) => s.name === streetFromMap) ?? matchStreetByLabel(streetFromMap, data.streets, next.workId);
				if (hit) {
					next.streetId = hit.id;
					next.workId = hit.workId;
				}
			}
			setDraft(next);
			return;
		...
		if (hydrated.current !== "new") {
			...
			const fromMap = streetFromMap ? streets.find((s) => s.name === streetFromMap) ?? matchStreetByLabel(streetFromMap, streets, base.workId) : void 0;
			setDraft({
				...base,
				estaca: estacaFromMap ? String(estacaFromMap) : base.estaca,
				streetId: fromMap?.id ?? base.streetId,
				workId: fromMap?.workId ?? base.workId
			});
			if (fromMap) {
				streetTouched.current = true;
				matchedStreet.current = true;

...
import { A as Camera, C as FileDown, D as ClipboardList, l as Settings2, n as ZoomOut, r as X, t as ZoomIn, x as Images, y as LocateFixed } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./app-shell-somMHvnL.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DuEVtjyS.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						})] }) : geo.error && !usingDemo ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClipboardList, { className: "size-4" }), cameraMatch ? `Apontar E-${cameraMatch.estaca} · ${cameraMatch.street.name.replace(/^Rua /, "")}` : "Abrir apontamento"]
						})
					]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative mx-3 mb-3 min-h-[320px] flex-1 overflow-hidden rounded-3xl border border-border shadow-2xl shadow-black/50",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StakeMap, {
					...
					className: "pointer-events-none absolute inset-x-0 bottom-0 z-20 flex items-end justify-between gap-2 p-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						className: "pointer-events-auto flex flex-col items-center gap-2 rounded-full border border-border bg-bg/70 p-1.5 backdrop-blur",
						children: [

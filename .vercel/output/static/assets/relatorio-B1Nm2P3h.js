import{n as e}from"./rolldown-runtime-CbXtAM7H.js";import{U as t,d as n,t as r}from"./createLucideIcon-nGl6uDlp.js";import{j as i,o as a}from"./use-snapshot-ZdMufxxe.js";import{a as o,i as s,s as c,t as l,u}from"./app-shell-CD1POVcg.js";import{n as d,t as f}from"./share-2-CXkkLLsw.js";import{r as p}from"./index-NxhCdBdj.js";import{t as m}from"./screen-loader-Dyi_pxkm.js";import{n as h,t as g}from"./input-Dm0tYSIs.js";var _=r(`copy`,[[`rect`,{width:`14`,height:`14`,x:`8`,y:`8`,rx:`2`,ry:`2`,key:`17jyea`}],[`path`,{d:`M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2`,key:`zix9uf`}]]),v=r(`printer`,[[`path`,{d:`M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2`,key:`143wyd`}],[`path`,{d:`M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6`,key:`1itne7`}],[`rect`,{x:`6`,y:`14`,width:`12`,height:`8`,rx:`1`,key:`1ue0tg`}]]),y=e(t());function b(e){let t=e==null?``:String(e);return/[;"\n]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t}function x(e){return`\uFEFF${[[`Data`,`Início`,`Término`,`Duração`,`Obra`,`Rua`,`Máquina`,`Atividade`,`Estaca`,`PV`,`Qtd`,`Observações`,`Descrição`,`Latitude`,`Longitude`,`Local GPS`],...e.map(e=>{let t=e.end?o(c(e.start,e.end)):`em andamento`;return[s(e.date),e.start,e.end??``,t,e.workName,e.streetName,e.equipmentName,e.activityName,e.estaca,e.pv,e.quantity??``,e.notes,e.description,e.lat??``,e.lng??``,e.locationLabel].map(b)})].map(e=>e.join(`;`)).join(`
`)}`}function S(e,t,n){let r=new Blob([t],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e,a.click(),URL.revokeObjectURL(i)}function C(e,t){let n=[...t].sort((e,t)=>e.start.localeCompare(t.start)),r=`${s(e)}`,i=n[0]?.workName??``,a=[`${r}${i?` — ${i}`:``}`,``];if(n.length===0)return a.push(`Nenhum apontamento neste dia.`),a.join(`
`);for(let e of n){let t=e.end?`${e.start}–${e.end}`:`${e.start}–…`;a.push(`${t}  ${e.equipmentName}`);let n=[e.activityName,e.streetName,e.estaca&&`Estaca ${e.estaca}`,e.pv].filter(Boolean);a.push(n.join(` — `)),e.locationLabel&&a.push(`GPS: ${e.locationLabel}`),e.notes&&a.push(`Obs: ${e.notes}`),a.push(``)}return a.join(`
`).trim()+`
...
`),[n,b,k]);async function M(){await navigator.clipboard.writeText(j),p.success(`Diário copiado`)}async function N(){if(navigator.share){await navigator.share({title:`Diário de apontamento`,text:j});return}await M()}function P(){S(`apontamento_${n}_${b}.csv`,x(k),`text/csv;charset=utf-8`),p.success(`Planilha baixada (abre no Excel)`)}function F(){w(`Relatório de apontamento`,`
      ...
      <p class="meta">${s(n)} a ${s(b)} · ${k.length} registros</p>
      <table>
        <thead><tr>
        ...
        <tbody>
          ${k.map(e=>`<tr>
            <td>${s(e.date)}<br/>${e.start}${e.end?`–${e.end}`:``}</td>
